        ...
        <div className='container mt-5' style={{ maxWidth: '700px' }}>
            ...
            <div className='form-card'>
                <form>
                    ...
                    {/* <div className='mb-4'>
                        <label className='form-label'>🖼️ Image Url(Optional)</label>
                        <input
                            type='text'
                        ...
                        />
                        <small className='text-secondary'>Tips：Paste your image url here</small>
                    </div> */}
...
//             errorsCopy.body = '';
//         } else {
//             errorsCopy.body = 'Body is required';
//             valid = false;
//         }
...
//                 {postId ? 'Modify your post' : 'Make a new post'}
//             </h2>
//         );
//     }
...
//                         <div className="mb-4">
//                             <label htmlFor="imageUrl" className="form-label fw-semibold">Image URL (optional)</label>
//                             <input
//                                 id="imageUrl"
//                                 type="text"
...
//                         <button type="submit" className="btn btn-success w-100" onClick={saveOrUpdatePost}>
//                             Submit
//                         </button>
//                     </form>
//                 </div>
